...
//   console.log(singlePlaylist)
  ...
  return (
    <div className="w-full h-[calc(100vh-72px)] flex md:flex-row flex-col">
      {/* HOME SIDE BAR */}
      ...
      <div className=" flex flex-col  lg:flex-row lg:gap-6 w-full">
        ...
        <div className="w-full h-[220px] lg:w-[400px] bg-[#1a1818] lg:rounded-lg border-b border-white shadow-xl shadow-black shrink-0  sticky top-0 lg:h-[calc(100vh-72px)] p-2 sm:p-4">
          <div className="relative rounded-xl flex  overflow-hidden">
            <img
              src={
                singlePlaylist?.message?.playlistVideos[0]?.thumbnail ||
                "https://images.pexels.com/photos/3394939/pexels-photo-3394939.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
              }
              alt="Playlist cover"
            ...
            <div className="lg:absolute bottom-0 p-2 md:p-4 lg:p-6">
              ...
              <div className="flex items-center gap-2 text-gray-300 text-sm">
                <span>
                  {millify(singlePlaylist?.message?.playlistVideos?.length)} videos
                </span>
              </div>
            </div>
          </div>
